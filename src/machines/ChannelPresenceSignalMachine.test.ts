...
import { ChannelPresenceSignalMachine } from './ChannelPresenceSignalMachine'
import { Channel } from '../Channel'
import { Peer } from '../Peer'
import { InMemorySignalingAdapter } from '../adapters/InMemorySignalingAdapter'

describe('ChannelPresenceSignalMachine', () => {
  ...
  it('should start in inactive state', () => {
    const actor = createActor(ChannelPresenceSignalMachine, {
      input: {
        channel,
        peer,
        parentRef
